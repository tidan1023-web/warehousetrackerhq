...
export default function SettingsPage() {
  const { user, login } = useAuth() as { user: { id: string; name: string; email: string; employeeId: string; role: string; department?: string; about?: string } | null; login: (email: string, password: string) => Promise<void> };
