    ...
    <main>
      ...
      <section className="relative pt-32 sm:pt-40 pb-0 overflow-hidden" style={{ background: "linear-gradient(160deg, #111d35 0%, #1B2A4A 100%)" }}>
        ...
        <div className="relative w-full h-[50vh] sm:h-[65vh] md:h-[80vh]">
          <Image src="/images/obj-portrait.jpeg" alt="Coach Oliver Berdeen Johnson" fill className="object-cover object-top" sizes="100vw" priority />
          <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, transparent 40%, #111d35 100%)" }} />
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6" style={{ background: "var(--navy-dark)" }}>
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 md:gap-16">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">A Life in Nigeria</h2>
            ...
            <blockquote className="border-l-2 pl-5 italic my-8 text-white text-lg leading-relaxed" style={{ borderColor: "var(--gold)", fontFamily: "Georgia, serif" }}>
          ...
          <div>
            <h3 className="text-sm uppercase tracking-widest mb-8 text-gray-400" style={{ letterSpacing: "0.15em" }}>A Life&rsquo;s Record</h3>
            <div className="relative pl-7 border-l" style={{ borderColor: "rgba(201,162,39,0.3)" }}>
              {milestones.map((m, i) => (
                <div key={i} className="mb-7 relative">
                  <div className="absolute -left-[1.9rem] top-1 w-3 h-3 rounded-full border-2" style={{ background: "var(--navy-dark)", borderColor: "var(--gold)" }} />
                  <p className="text-xs mb-1 font-mono" style={{ color: "var(--gold)" }}>{m.year}</p>
                  <p className="text-gray-300 text-sm leading-relaxed" style={{ fontFamily: "Georgia, serif" }}>{m.label}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6" style={{ background: "var(--navy)" }}>
        <div className="max-w-6xl mx-auto">
          <p className="text-xs uppercase tracking-widest mb-8 text-gray-400 text-center" style={{ letterSpacing: "0.15em" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
            {[
              ...
              <div key={img.src} className="relative aspect-square rounded overflow-hidden group">
                <Image src={img.src} alt={img.caption} fill className="object-cover object-center group-hover:scale-105 transition-transform duration-500" sizes="(max-width:768px) 50vw, 33vw" />
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-3" style={{ background: "linear-gradient(to top, rgba(17,29,53,0.9) 0%, transparent 60%)" }}>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6" style={{ background: "var(--navy-dark)" }}>
        <div className="max-w-6xl mx-auto">
          <div className="p-8 sm:p-10 rounded" style={{ background: "rgba(201,162,39,0.07)", border: "1px solid rgba(201,162,39,0.2)" }}>
            <p className="text-xs uppercase tracking-widest mb-4" style={{ color: "var(--gold)", letterSpacing: "0.15em" }}>Basketball for Peace</p>
            <p className="text-gray-300 leading-relaxed mb-5 max-w-3xl" style={{ fontFamily: "Georgia, serif" }}>
            ...
            <blockquote className="border-l-2 pl-5 italic text-gray-300 text-base sm:text-lg leading-relaxed max-w-2xl" style={{ borderColor: "var(--gold)", fontFamily: "Georgia, serif" }}>
